/*!
 * yesbhautik: Front-end site library
 * @license MIT
 * Inline scripts may access the api using an async handler:
 *   var yesbhautik = yesbhautik || [];
 *   yesbhautik.push(readyFunction);
 */
/******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * yesbhautik: Core site library
       */

      var yesbhautik = {};
      var modules = {};
      var primary = [];
      var secondary = window.yesbhautik || [];
      var $ = window.jQuery;
      var $win = $(window);
      var $doc = $(document);
      var isFunction = $.isFunction;

      var _ = (yesbhautik._ = __webpack_require__(131));

      var tram = (yesbhautik.tram = __webpack_require__(69) && $.tram);
      var domready = false;
      var destroyed = false;
      tram.config.hideBackface = false;
      tram.config.keepInherited = true;
      /**
       * yesbhautik.define - Define a named module
       * @param  {string} name
      ...
      yesbhautik.define = function (name, factory, options) {
        if (modules[name]) {
      ...
      /**
       * yesbhautik.require - Require a named module
       * @param  {string} name
       * @return {object}
       */

      yesbhautik.require = function (name) {
        return modules[name];
      };

      function bindModule(module) {
        // If running in yesbhautik app, subscribe to design/preview events
        if (yesbhautik.env()) {
      ...
      /**
       * yesbhautik.push - Add a ready handler into secondary queue
       * @param {function} ready  Callback to invoke on domready
       */

      yesbhautik.push = function (ready) {
      ...
      /**
       * yesbhautik.env - Get the state of the yesbhautik app
       * @param {string} mode [optional]
       * @return {boolean}
       */

      yesbhautik.env = function (mode) {
        ...
        if (mode === "editor") {
          return window.yesbhautikEditor;
        }
      ...
      var touch = (yesbhautik.env.touch =
        "ontouchstart" in window ||
        (window.DocumentTouch && document instanceof window.DocumentTouch));
      var chrome = (yesbhautik.env.chrome =
        /chrome/.test(userAgent) &&
        /Google/.test(navigator.vendor) &&
        parseInt(userAgent.match(/chrome\/(\d+)\./)[1], 10));
      var ios = (yesbhautik.env.ios = /(ipod|iphone|ipad)/.test(userAgent));
      yesbhautik.env.safari = /safari/.test(userAgent) && !chrome && !ios; // Maintain current touch target to prevent late clicks on touch devices
      ...
      /**
       * yesbhautik.validClick - validate click target against current touch target
       * @param  {HTMLElement} clickTarget  Element being clicked
       * @return {Boolean}  True if click target is valid (always true on non-touch)
       */

      yesbhautik.validClick = touch
      ...
      /**
       * yesbhautik.resize, yesbhautik.scroll - throttled event proxies
       */

      var resizeEvents =
        "resize.yesbhautik orientationchange.yesbhautik load.yesbhautik";
      var scrollEvents = "scroll.yesbhautik " + resizeEvents;
      yesbhautik.resize = eventProxy($win, resizeEvents);
      yesbhautik.scroll = eventProxy($win, scrollEvents);
      yesbhautik.redraw = eventProxy(); // Create a proxy instance for throttled events
      ...
      function eventProxy(target, types) {
        ...
        return proxy;
      } // yesbhautik.location - Wrap window.location in api

      yesbhautik.location = function (url) {
        window.location = url;
      };

      if (yesbhautik.env()) {
        // Ignore redirects inside a yesbhautik design/edit environment
        yesbhautik.location = function () {};
      } // yesbhautik.ready - Call primary and secondary handlers

      yesbhautik.ready = function () {
      ...
      /**
       * yesbhautik.load - Add a window load handler that will run even if load event has already happened
       * @param  {function} handler
       */

      var deferLoad;

      yesbhautik.load = function (handler) {
      ...
      } // yesbhautik.destroy - Trigger a destroy event for all modules

      yesbhautik.destroy = function (options) {
        options = options || {};
        destroyed = true;
        ...
        yesbhautik.resize.off();
        yesbhautik.scroll.off();
        yesbhautik.redraw.off(); // Clear any queued ready methods
      ...
      $(yesbhautik.ready); // Listen for window.onload and resolve deferred

      bindLoad(); // Export commonjs module

      module.exports = window.yesbhautik = yesbhautik;
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * yesbhautik: IX Event triggers for other modules
       */
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _IX2BrowserSupport = __webpack_require__(48); // eslint-disable-next-line yesbhautik/module-top-level-imports, yesbhautik/packages-must-be-defined
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * yesbhautik: Brand pages on the subdomain
       */

      var yesbhautik = __webpack_require__(3);
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($) {
          ...
          //     width: '16px'
          //   });
          //   var $logoText = $('<img>').attr('src', 'https://d1otoma47x30pg.cloudfront.net/img/yesbhautik-badge-text.6faa6a38cd.svg').attr('alt', 'Made in yesbhautik');
          ...
          function ensureBrand() {
            ...
            var inEditor = yesbhautik.env("editor");
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /*!
       * yesbhautik._ (aka) Underscore.js 1.6.0 (custom build)
       * _.each
       * _.map
       * _.find
       * _.filter
      ...
      module.exports = (function () {
        ...
        _.VERSION = "1.6.0-yesbhautik"; // Establish the object that gets returned to break out of a loop iteration.
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($, _, options) {
          ...
          if (yesbhautik.env("test") || yesbhautik.env("frame")) {
          ...
          try {
            ...
            hasLocalStorage =
              ...
              localStorage.getItem("yesbhautikEditor");
          } catch (e) {
          ...
          function load() {
            loaded = true; // Predefine global immediately to benefit yesbhautik.env

            window.yesbhautikEditor = true;
          ...
          function prefix(url) {
            return url.indexOf("//") >= 0
              ? url
              : cleanSlashes("https://editor-api.yesbhautik.com" + url);
          }
          ...
          function checkThirdPartyCookieSupport(callback) {
            ...
            iframe.src =
              "https://yesbhautik.com" + "/site/third-party-cookie-check.html";
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * yesbhautik: focus-within
       */

      var yesbhautik = __webpack_require__(3); // polyfill based off of https://github.com/matteobad/focus-within-polyfill
...
*/
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var createPluginInstance = function createPluginInstance(element) {
        var instance = window.yesbhautik
          .require("lottie")
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /**
       * yesbhautik: Auto-select links to current page or section
       */
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($, _) {
          ...
          function init() {
            designer = inApp && yesbhautik.env("design");
            slug = yesbhautik.env("slug") || location.pathname || ""; // Reset scroll listener, init anchors

            yesbhautik.scroll.off(scroll);
          ...
          function select(link) {
            ...
            if (
              ...
              // https://forum.yesbhautik.com/t/dropdown-menus-not-working-on-site/87140
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($) {
          ...
          function validateScroll(evt) {
            ...
            if (
              // Bail if in Designer
              yesbhautik.env("design") || // Ignore links being used by jQuery mobile
              (window.$.mobile &&
          ...
          function updateHistory(hash) {
            ...
            if (
              ...
              !(yesbhautik.env.chrome && loc.protocol === "file:")
            ) {
  ...
  document,
  FormData,
  yesbhautik_FORM_API_HOST,
  yesbhautik_FORM_OLDIE_HOST
*/
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($, _) {
          ...
          function init() {
            ...
            if (retro && formUrl.indexOf("https://yesbhautik.com") >= 0) {
              formUrl = formUrl.replace(
                "https://yesbhautik.com",
                "https://formdata.yesbhautik.com"
              );
            }
          ...
          function build(i, el) {
            ...
            if (action) {
              return;
            } // yesbhautik forms for hosting accounts

            if (siteId) {
              data.handler =
                typeof hostedSubmityesbhautik === "function"
                  ? hostedSubmityesbhautik
                  : exportedSubmityesbhautik;
              return;
            } // Alert for disconnected yesbhautik forms

            disconnected();
          }

          function addListeners() {
            listening = true; // Handle form submission for yesbhautik forms
          ...
          function exportedSubmityesbhautik(data) {
            preventDefault(data);
            afterSubmit(data);
          }
          /* yesbhautik_HOSTED_BLOCK:START */
          // Submit form to yesbhautik

          function hostedSubmityesbhautik(data) {
            reset(data);
            var form = data.form;
            var payload = {
              name:
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($, _) {
          ...
          function init() {
            designer = inApp && yesbhautik.env("design");
            inEditor = yesbhautik.env("editor");
          ...
          function removeListeners() {
            yesbhautik.resize.off(resizeAll);
          }

          function addListeners() {
            yesbhautik.resize.on(resizeAll);
          }
          ...
          function navigate(data) {
            return function (evt) {
              ...
              if (!yesbhautik.validClick(evt.currentTarget)) {
                evt.preventDefault();
                return;
          ...
          function open(data, immediate) {
            ...
            resize(0, navbarEl);
            ix.intro(0, navbarEl);
            yesbhautik.redraw.up(); // Listen for click outside events
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      yesbhautik.define(
        ...
        (module.exports = function ($) {
          ...
          function init() {
            design = inApp && yesbhautik.env("design"); // Find all instances on the page
            ...
            if (yesbhautik.env("preview") && !inRedraw) {
              $tabs.each(resetIX);
            }
          ...
          function removeListeners() {
            yesbhautik.redraw.off(api.redraw);
          }

          function addListeners() {
            yesbhautik.redraw.on(api.redraw);
          }
          ...
          function fadeIn(config, $previous, $targets) {
            ...
            $targets.addClass(tabActive).each(ix.intro);
            yesbhautik.redraw.up(); // Set opacity immediately if intro is zero
...
/**
 * ----------------------------------------------------------------------
 * yesbhautik: Interactions 2.0: Init
 */
yesbhautik.require("ix2").init({
  events: {
    "e-6": {
      id: "e-6",
      name: "",
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "0b8580f0-801f-69ab-44f1-13e26b422f74",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-14": {
      ...
      action: {
        ...
        actionTypeId: "POP_EFFECT",
        instant: false,
        config: { actionListId: "pop", autoStopEventId: "e-13" },
      },
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "0b8580f0-801f-69ab-44f1-13e26b422f74",
    ...
    "e-15": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1ed511e5-5ac5-3e19-25a3-f1d3164000ee",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                locked: false,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|bc579dfb-3e82-346b-1724-e3b777109326",
                },
                widthValue: 100,
                heightValue: 0,
                widthUnit: "%",
            ...
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|f88a9e19-8d9a-4494-1d67-ae094a3c86bb",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|c3817bfa-3dce-a3ca-1a44-80ba9971f07a",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|80384578-1d03-8c89-c841-4b2444219fcb",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|087cdaa1-80f6-fd7e-7e2f-370e86c74263",
                },
                value: 0,
                unit: "",
              },
            },
            {
              ...
              config: {
                ...
                duration: 500,
                target: {
                  id: "63cea2fe5823cc6aa356c85f|543c2c89-952e-4389-b75f-167f284402d8",
                },
                yValue: 100,
                xUnit: "PX",
                yUnit: "%",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".button.is-nav.close",
                  selectorGuids: [
                    "c9fa9501-014d-1896-8588-1b3a3f210ab3",
                    "2811e522-fd30-5a60-33d8-5bbd013eb314",
                    "56bc5d67-71de-659d-5195-6224609f1473",
                  ],
                },
                value: "block",
              },
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".button.is-nav.menu",
                  selectorGuids: [
                    "c9fa9501-014d-1896-8588-1b3a3f210ab3",
                    "2811e522-fd30-5a60-33d8-5bbd013eb314",
                    "a454c020-c6af-b285-d64e-adf0a2c7efcb",
                  ],
                },
                value: "none",
              },
